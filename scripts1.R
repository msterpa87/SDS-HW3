...
# Correlation matrices for ASD and TD groups --------
...
#Visualize them
corrplot(round(cor.asd.pooled,3), method="circle", order="hclust",
...
# building adjacency matrix for TD group
td.adj.matrix <- build.assoc.graph(cor.asd, cor.td, threshold)

# Point 3 ---------------------------

# simple plotting functions ASD
