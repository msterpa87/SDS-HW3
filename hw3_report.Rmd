...
## Conclusions
Through the difference graph we can visualize clearly the co-activation differences between the two groups. Indeed there are a couple of communities that are formed by more edges than the others; that communities point out the dissimilarities we are looking for.  
```{r}
